...
class DSBMMBase:
    ...
    _pi: Array(float64, ndim=2, layout="C")  # type: ignore # noqa: F821 # group transition mat
    _lam: float64[:, :, ::1]  # block pois params in DC case
    _beta: Array(  # type: ignore
        float64, ndim=3, layout="C"  # type: ignore # noqa: F821
