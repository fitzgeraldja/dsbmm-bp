...
do
  ...
  python toy_apply.py --name_ext "_hardpmeta${proc_num}" --params_path "/scratch/fitzgeraldj/data/toy_sims/toy_param_grid_hard${proc_num}.pkl" --msg_init_mode planted_meta &
done 
exit 0
