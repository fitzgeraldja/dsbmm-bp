...
def nb_update_alpha(
    ...
    if init:
        ...
        tmp = node_marg.sum(axis=0).sum(axis=0)
        tmp /= _tot_N_pres
        if tmp.sum() > 0:
            tmp /= tmp.sum()
        tmp[tmp < TOL] = TOL
...
def nb_update_pi(
    ...
    if init:
        ...
        qqprime_trans = twopoint_time_marg.sum(axis=0).sum(axis=0)
...
def nb_update_beta(
    ...
    Args:
        init (bool): _description_
        learning_rate (float): _description_
        directed (bool): _description_
        _edge_vals (np.ndarray): _description_
        _pres_nodes (np.ndarray): _description_
        nbrs (_type_): _description_
        degs (np.ndarray): _description_
        _n_qt (np.ndarray): _description_
        T (int): _description_
        Q (int): _description_
        Z (np.ndarray): _description_
        _beta (np.ndarray): _description_
        node_marg (np.ndarray): _description_
        twopoint_edge_marg (_type_): _description_
        diff (float): _description_
